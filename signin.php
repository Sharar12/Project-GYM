...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="canvas-social">
          ...
          <a href="./signin.php"  class="active"><i class="  fa fa-user"></i></a>
        </div>
    </div>
                    ...
                    <form action="login.php" method="post">
                            ...
                            <input type="password" name="Password" placeholder="Password">
                                ...
                                <div class="col-lg-12" style="display: flex; justify-content: center; margin-top: 20px;">
                                    <a href="./admin.php" 
                                    style="background-color: #FF0000; color: white; padding: 12px 20px; 
                                            border-radius: 25px; text-decoration: none; font-size: 16px; 
                                            text-align: center; display: inline-block; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                                        For Admin
                                    </a>
                                </div>
